...
# CLI command show 
class show{
	public function controller($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/controller'; $init_dir = $c_dir.'/*';
	...
	public function model($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/model'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function library($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/library'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function package($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/package'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function extender($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/extender'; $init_dir = $c_dir.'/.php*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function init($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/extender/init'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function api($api=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/extender/init'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function module($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/modules'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function live_module($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/modules'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function git_module($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/modules'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function live_package($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/packages'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
	...
	public function git_package($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/packages'; $init_dir = $c_dir.'/*';
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  $msg = "\n";
