...
class compile{
	...
	public function extender(){ $msg=BAD_FORMAT(); $c_dir = 'app/extender'; $init_dir = $c_dir.'/init';
	...
	public function one($extender){ $msg=BAD_FORMAT(); $c_dir = 'app/extender'; $init_dir = $c_dir.'/init';
