...
class explain{
	var $server_uri;
	public function module($module=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/modules'; $init_dir = $c_dir.'/'.$module.'/init.php';
	...
	public function extender($extender=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/extender'; $init_dir = $c_dir.'/'.$extender.'.php';
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  $msg = "\n";
	...
	public function init($extender=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/extender/init'; $init_dir = $c_dir.'/'.$extender.'.php';
		  require_once 'cli-terminal.php';
		  $colors = new Colors();
		  //if(!is_dir($init_dir)) mkdir($init_dir,777);
		  $msg = "\n";
