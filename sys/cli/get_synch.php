...
class getSynch{
	...
	public function controller($fileName,$dest=NULL,$url=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/controller'; $file = $c_dir.'/'.ucfirst($fileName.'.php');
		if (file_exists($file)){
	...
	public function model($fileName,$dest=NULL,$url=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/model'; $file = $c_dir.'/'.ucfirst($fileName.'.php');
		if (file_exists($file)){
			if(is_dir($c_dir) && is_writable($c_dir) && is_readable($file)){
				$fileContent = base64_encode(file_get_contents($file));
				$dest		 = ($dest!=NULL)?$dest:$fileName;
	...
	public function library($fileName,$dest=NULL,$url=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/library'; $file = $c_dir.'/'.ucfirst($fileName.'.php');
		if (file_exists($file)){
			if(is_dir($c_dir) && is_writable($c_dir) && is_readable($file)){ 
		  		$fileContent = base64_encode(file_get_contents($file));
				$dest		 = ($dest!=NULL)?$dest:$fileName;
	...
	public function extender($fileName,$dest=NULL,$url=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/extender'; $file = $c_dir.'/'.ucfirst($fileName.'.php');
		if (file_exists($file)){
			if(is_dir($c_dir) && is_writable($c_dir) && is_readable($file)){ 
		  		$fileContent = base64_encode(file_get_contents($file));
				$dest		 = ($dest!=NULL)?$dest:$fileName;
	...
	public function package($fileName,$dest=NULL,$url=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/package'; $file = $c_dir.'/'.ucfirst($fileName.'.php');
		if (file_exists($file)){
			if(is_dir($c_dir) && is_writable($c_dir) && is_readable($file)){ 
		  		$fileContent = base64_encode(file_get_contents($file));
				$dest		 = ($dest!=NULL)?$dest:$fileName;
	...
	public function module($fileName,$dest=NULL,$url=NULL){ $msg=BAD_FORMAT(); $c_dir = 'app/modules'; $file = $c_dir.'/'.strtolower($fileName);
		if (file_exists($file)){
			if(is_dir($c_dir) && is_writable($c_dir) && is_readable($file)){ 
